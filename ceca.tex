...
Calculs de coûts (chaîne de valeur), seuil de rentabilité, compte de résultats prévisionnel, tableau de trésorerie et plan de financement en annexe:\\

le compte de résultats prévisionel [Figure ~\ref{fig:compte_previsionel}],
le plan de financement [Figure ~\ref{fig:pf}],
le plan de trésorerie [Figure ~\ref{fig:tresorerie}],
et le tableau d'amortissement de l'emprunt [Figure ~\ref{fig:emprunt}].\\
